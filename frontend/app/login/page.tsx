    ...
    <div className="min-h-[60vh] flex items-center justify-center">
      <div className="bg-white border border-[#d8d3c9] rounded-2xl p-8 max-w-md w-full animate-fade-in">
        ...
        <button
          ...
          className="w-full py-2.5 border border-[#d8d3c9] text-sm font-medium rounded-lg hover:bg-[#fafaf8] transition-colors flex items-center justify-center gap-3"
        >
        ...
        <div className="relative my-6">
          <div className="absolute inset-0 flex items-center">
            <div className="w-full border-t border-[#d8d3c9]"></div>
          </div>
          <div className="relative flex justify-center text-xs">
            <span className="bg-white px-3 text-[#7a7670]">or</span>
          </div>
        </div>
        ...
        <p className="text-center text-sm text-[#7a7670] mt-6">
          ...
          <Link href="/register" className="text-[#1F6B3A] hover:underline">
            Create one
          </Link>
        </p>
      </div>
